...
import { EVENTS as e, elements, RANK } from './conf.js';
import { absMod, setTooltip, forceHideTooltip } from './misc.js';
import { colorUtils as color, eventSys } from './util.js';
import { renderer, mouse } from './canvas_renderer.js';
...
import { showPlayerList } from './Player.js';
...
export const player = {
	...
	get toolId() { return OldProtocol.tools.id[toolSelected.id]; },
