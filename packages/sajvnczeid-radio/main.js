!function () { //Made with Help of Lapis for cheesing out the audio
	var audio = new Audio();
	...
	OWOP.client.windowSys.addWindow(new OWOP.client.GUIWindow("Sajvnczeid Radio!", {
		closeable: false,
		moveable: true
	}, h => {
		WINDOW = h;
	...
	cont.oninput = function () {
		...
		document.getElementById("volid").innerHTML = `Volume: ${audio.volume.toFixed(2)}`
	};
	...
	document.getElementById("PP").addEventListener("click", () => {
		audio.play(); document.getElementById("volid").innerHTML = `Volume: ${audio.volume.toFixed(2)}`; document.getElementById("h1").innerHTML = `Now Playing: ${cname}`
	});
	...
	document.getElementById("CLS").addEventListener("click", () => {
		stopPlaying()
		OWOP.client.windowSys.windows['Sajvnczeid Radio!'].container.outerHTML = "";
		OWOP.client.windowSys.windows['Sajvnczeid Radio!'].frame.outerHTML = "";
	});


	document.getElementById("C").addEventListener("click", () => {
		OWOP.client.windowSys.addWindow(new OWOP.client.GUIWindow("Credits!", {
			closeable: true,
			moveable: true
		}, r => {
			WINDOW = r;
