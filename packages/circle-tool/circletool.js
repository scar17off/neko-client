(function () {
    const addTool = OWOP.client.addTool;
    const Tool = OWOP.client.Tool;
    const cursors = OWOP.client.cursors;
    const PLAYERFX = OWOP.canvas.PLAYERFX;
    const RANK = OWOP.client.RANK;
    const player = OWOP.client.player;
    const misc = OWOP.misc;
    const camera = OWOP.client.camera;
